...
PARENT_DIR="/home/thomas/BPEXA_repo/metatrans-smk-hs"
if [ "$1" != "" ]; then
	PARENT_DIR="$1"
fi
INPUT_DIR=${PARENT_DIR}"/sample-data/subset-raw-libs"
...
#for fwdpath in "${INPUT_DIR}"/*_R1_*.fq.gz;
for fwdpath in ${INPUT_DIR}/*_R1_*;
do
